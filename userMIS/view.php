 ...
 if($result){
  while($row=(mysqli_fetch_assoc($result)))
  {
   ...
   $idno=$row['idno'];
    ...
    <td>'.$idno.'</td>
    <td>
    <button><a href="edit.php?updateuserid='.$userid.'">UPDATE</a></button>
    <button><a href="delete.php?deleteuserid='.$userid.'">DELETE</a></button>
    </td>
    </tr>';
  }
 }
...
<a class="btn btn-primary btn-xl" href="userdoc.php">EXPORT DATA INTO WORD DOCUMENT</a>
</div>
</div>
</div>
