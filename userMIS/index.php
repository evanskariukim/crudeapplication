    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1">MANAGE USER ONLINE</h1>
                <h3 class="mb-5"><em>This is a web-based application to manage user.</em></h3>
                <a class="btn btn-primary btn-xl" href="register.php">GET STARTED</a>
            </div>
        </header>
        ...
        <footer class="footer text-center">
            <div class="container px-4 px-lg-5">
                ...
                <p class="text-muted small mb-0">Copyright &copy; EVANS KARIUKI MUNIU</p>
            </div>
        </footer>
